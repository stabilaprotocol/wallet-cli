              ...
              try {
                ...
                switch (contract.getType()) {
                  ...
                  case VoteExecutiveContract:
                    VoteExecutiveContract voteExecutiveContract =
                        contractParameter.unpack(VoteExecutiveContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(voteExecutiveContract, selfType));
                    break;
                  case ExecutiveCreateContract:
                    ExecutiveCreateContract executiveCreateContract =
                        contractParameter.unpack(ExecutiveCreateContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(executiveCreateContract, selfType));
                    break;
                  ...
                  case ExecutiveUpdateContract:
                    ExecutiveUpdateContract executiveUpdateContract =
                        contractParameter.unpack(ExecutiveUpdateContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(executiveUpdateContract, selfType));
                    break;
                  ...
                  case CdBalanceContract:
                    CdBalanceContract cdBalanceContract =
                        contractParameter.unpack(CdBalanceContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(cdBalanceContract, selfType));
                    break;
                  case UncdBalanceContract:
                    UncdBalanceContract uncdBalanceContract =
                        contractParameter.unpack(UncdBalanceContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(uncdBalanceContract, selfType));
                    break;
                  ...
                  case UncdAssetContract:
                    UncdAssetContract uncdAssetContract =
                        contractParameter.unpack(UncdAssetContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(uncdAssetContract, selfType));
                    break;
                  ...
                  case UpdateUcrLimitContract:
                    UpdateUcrLimitContract updateUcrLimitContract =
                        contractParameter.unpack(UpdateUcrLimitContract.class);
                    contractJson =
                        JSONObject.parseObject(
                            JsonFormat.printToString(updateUcrLimitContract, selfType));
                    break;
