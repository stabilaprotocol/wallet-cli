...
//  }
  ...
  public TransactionExtention createTransaction2(CdBalanceContract contract) {
    return blockingStubFull.cdBalance2(contract);
  }
  ...
  public TransactionExtention createTransaction2(UncdBalanceContract contract) {
    return blockingStubFull.uncdBalance2(contract);
  }

  public Transaction createTransaction(UncdAssetContract contract) {
    return blockingStubFull.uncdAsset(contract);
  }

  public TransactionExtention createTransaction2(UncdAssetContract contract) {
    return blockingStubFull.uncdAsset2(contract);
  }
  ...
  public TransactionExtention voteExecutiveAccount2(VoteExecutiveContract contract) {
    return blockingStubFull.voteExecutiveAccount2(contract);
  }
  ...
  public TransactionExtention createExecutive2(ExecutiveCreateContract contract) {
    return blockingStubFull.createExecutive2(contract);
  }

  public Transaction updateExecutive(ExecutiveUpdateContract contract) {
    return blockingStubFull.updateExecutive(contract);
  }

  public TransactionExtention updateExecutive2(ExecutiveUpdateContract contract) {
    return blockingStubFull.updateExecutive2(contract);
  }
...
//  }
  ...
  public Optional<ExecutiveList> listExecutives() {
    if (blockingStubSolidity != null) {
      ExecutiveList executiveList = blockingStubSolidity
          .listExecutives(EmptyMessage.newBuilder().build());
      return Optional.ofNullable(executiveList);
    } else {
      ExecutiveList executiveList = blockingStubFull.listExecutives(EmptyMessage.newBuilder().build());
      return Optional.ofNullable(executiveList);
    }
  }
...
//  }
  ...
  public TransactionExtention updateUcrLimit(
      UpdateUcrLimitContract request) {
    return blockingStubFull.updateUcrLimit(request);
  }
