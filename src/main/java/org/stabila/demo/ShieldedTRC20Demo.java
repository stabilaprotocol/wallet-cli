...
import org.stabila.walletserver.GrpcClient;
...
import org.stabila.api.GrpcAPI.SpendNoteTRC20;
...
import org.stabila.common.utils.Hash;
...
public class ShieldedTRC20Demo {
  ...
  private byte[] triggerGetScalingFactor(byte[] contractAddress) {
    ...
    GrpcAPI.TransactionExtention stbExt2 = grpcClient.triggerConstantContract(
        triggerBuilder.build());
    List<ByteString> list = stbExt2.getConstantResultList();
